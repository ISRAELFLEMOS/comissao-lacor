# Código completo com exportação corrigida para CSV (sem openpyxl)
codigo_csv_final = '''
...
arquivo_csv_py = "/mnt/data/app_comissao_streamlit_COMPLETO.py"
with open(arquivo_csv_py, "w", encoding="utf-8") as f:
    f.write(codigo_csv_final)
